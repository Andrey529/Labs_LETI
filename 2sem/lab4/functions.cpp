...
//    char name_output[nameFile];     // file to output result of program
    ...
    f_in1.open(/*name_input_firstText*/"/home/andrey/Projects/Labs_LETI/2sem/lab4/text-files/text1.txt",std::ios::in);
    if(f_in1.bad()){
...
//    std::cout << "The first text will be input in file " << name_input_firstText << "." << std::endl;
    ...
    f_in2.open(/*name_input_secondText*/"/home/andrey/Projects/Labs_LETI/2sem/lab4/text-files/text2.txt", std::ios::in);
    if (f_in2.bad()) {
...
//    std::cout << "The second text will be input in file " << name_input_secondText << "." << std::endl;
    ...
    f_out.open(/*name_output*/"/home/andrey/Projects/Labs_LETI/2sem/lab4/text-files/result.txt", std::ios::out);
    if (f_out.bad()) {

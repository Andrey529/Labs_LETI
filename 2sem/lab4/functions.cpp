...
bool checkFilesIsOpen(std::fstream &f_in1, std::fstream &f_in2, std::fstream &f_out){
    ...
    f_in1.open(name_input_firstText,std::ios::in);
    if(f_in1.bad()){
    ...
    f_in2.open(name_input_secondText, std::ios::in);
    if (f_in2.bad()) {
    ...
    std::cin >> name_output;     // C:\Users\andre\CLionProjects\leti_progs\2sem\lab4\text-files\result.txt
                                   // /home/andrey/Projects/Labs_LETI/2sem/lab4/text-files/result.txt
